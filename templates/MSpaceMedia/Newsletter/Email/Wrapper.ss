...
<body style="margin:0;padding:0;background-color:$Brand.BodyBackground;">
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:$Brand.BodyBackground;">
        $PreheaderText.XML
    </div>
